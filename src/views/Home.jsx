    ...
    <>
          ...
          <div className="stats">
            <div className="gap-0 px-10 bg-transparent stat place-items-center hover:opacity-70">
              {supply ? (
                ...
                <button class="btn btn-sm btn-circle stat-value loading"> </button>
              )}

              <div className="stat-desc">Already Minted</div>
            </div>{" "}
            <div className="gap-0 px-10 bg-transparent stat place-items-center hover:opacity-70">
      ...
      <footer style={{ background: "rgb(233, 217, 180)" }} className="p-10 footer text-primary-content footer-center">
        <div>
          ...
          <p className="font-bold text-secondary text-xl">Crabrades</p>
          <p className="font-bold text-secondary text-xl">Copyright © 2021 - All right reserved</p>
        </div>
        <div>
